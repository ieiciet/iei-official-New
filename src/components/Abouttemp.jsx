    ...
    <div>
      <section className='sm:px-20 xl:px-36 px-10 w-full pt-14 pb-14 h-auto flex flex-col'>
        <div className='flex flex-col py-11 gap-6'>
          ...
          <p className='text-gray-400 sm:text-left w-full text-center text-[18px] font-poppins'> The Institution of Engineers (India) Student Chapter at Chitkara University  is one of the growing technical society in the university.</p>
