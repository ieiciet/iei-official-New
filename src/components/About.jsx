        ...
        <div>
            <section className='sm:px-20 xl:px-36 px-10 bg-bg w-full pt-14 pb-14 h-[100vh] flex'>
                <div className='flex flex-col py-11 w-[60%] gap-6 pr-9 justify-evenly'>
                    ...
                    <p className='text-gray-400 sm:text-left w-full text-center text-[18px] font-poppins'>I Student Chapter, Chitkara University is one of the growing technical society in the university.</p>
